        ...
        <div>
            <nav className="navbar z-50">
                <ul className="navbar-nav">
                    <li className="logo">
                        <a href="/pages/guesser" className="nav-link">
                            <span className="link-text logo-text">Guess</span>
                            <svg
                    ...
                    <li className="logo">
                        <a href="/pages/collection" className="nav-link">
                            <span className="link-text logo-text">Collection</span>
                            <svg
                                //Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.
                                aria-hidden="true"
                                focusable="false"
